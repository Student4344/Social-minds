...
const AuthPage = () => {
  ...
  // 🔴 FIXED Google OAuth (Supabase only)
    ...
    <div className="min-h-screen mesh-gradient flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center space-y-3">
          ...
          <h1 className="font-display text-3xl font-bold neon-text text-foreground">
            Social Bloom
          </h1>
        ...
        <div className="glass-card rounded-2xl p-6 space-y-4">
          ...
          <motion.button
            ...
            disabled={loading}
            className="w-full bg-white text-black py-3 rounded-xl font-medium text-sm flex items-center justify-center gap-2 hover:bg-gray-100 transition-colors"
          >
        ...
        <p className="text-center text-xs text-muted-foreground px-4">
          ⚠️ Social Bloom is an AI companion, not a licensed therapist. If you're
          in crisis, call 988 (US) or 112.
        </p>
      </motion.div>
    </div>
  );
